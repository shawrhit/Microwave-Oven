/*
 * Character LCD (CLCD) Hardware Abstraction Layer
 *
 * Provides 4-bit mode communication helpers and addressing macros
 * for a 16x4 character LCD. Timing is critical; do not alter delays.
 */
...
#define DISP_ON_AND_CURSOR_BLINK    0x0F   // Display ON, Cursor ON, Blink ON
