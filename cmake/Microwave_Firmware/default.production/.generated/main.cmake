...
add_executable(Microwave_Firmware_default_image_XOQyM87n ${Microwave_Firmware_default_library_list})

set_target_properties(Microwave_Firmware_default_image_XOQyM87n PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${Microwave_Firmware_default_output_dir})
set_target_properties(Microwave_Firmware_default_image_XOQyM87n PROPERTIES OUTPUT_NAME "default-production")
set_target_properties(Microwave_Firmware_default_image_XOQyM87n PROPERTIES SUFFIX ".elf")

target_link_libraries(Microwave_Firmware_default_image_XOQyM87n PRIVATE ${Microwave_Firmware_default_default_XC8_FILE_TYPE_link})


# Add the link options from the rule file.
Microwave_Firmware_default_link_rule(Microwave_Firmware_default_image_XOQyM87n)
